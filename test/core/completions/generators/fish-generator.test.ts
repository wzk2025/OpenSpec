...
describe('FishGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid fish completion script with header', () => {
      ...
      expect(script).toContain('# Fish completion script for RdSpec CLI');
      expect(script).toContain('function __fish_rd');
    });
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_rd_using_subcommand');
      expect(script).toContain('function __fish_rd_no_subcommand');
    ...
    it('should include all commands with descriptions', () => {
      ...
      expect(script).toContain("complete -c rd");
      expect(script).toContain("-a 'init'");
      expect(script).toContain("'Initialize RdSpec'");
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_rd_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_rd_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_rd_specs');
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain('__fish_rd_items');
    });
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_rd_changes');
      expect(script).toContain('rd __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_rd_specs');
      expect(script).toContain('rd __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_rd_items');
      expect(script).toContain('__fish_rd_changes');
      expect(script).toContain('__fish_rd_specs');
    });
